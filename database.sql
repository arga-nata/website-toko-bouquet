...
(
    ...
    kategori_harga   enum ('Rp 15.000 - 50.000','Rp 100.000','Rp 150.000','Rp 200.000','Rp 250.000','Rp 350.000','Rp 500.000','Rp 150.000 - 185.000')                                             DEFAULT NULL,
    jenis_buket      enum ('Buket Wisuda','Buket Ulang Tahun','Buket Anniversary','Balon Karakter','Balon Angka/Huruf','Balon Custom','Hampers Lebaran','Hampers Natal','Hampers Makanan Ringan') DEFAULT NULL
) ENGINE = InnoDB
...
(
    ...
    nama_kategori enum ('Buket Bunga','Buket Balon','Hampers') DEFAULT NULL
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci;
...
insert into produk (id_produk, id_kategori, gambar)
values (7, 1, 'images/flower_item_4.jpeg');
